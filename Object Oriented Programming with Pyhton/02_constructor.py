#In python, the constructor is invoked by a function named def __init__().
...
#self --> The self parameter is the reference to the current instance of the class and it is used to access variables that belongs to that class.
class Student:
